...
class SignupView(View):
    ...
    def ValidateCustomer(self,customer):
        ...
        if (not customer.first_name):
            ...
            error_message = "first_name should be more than  4 char"
...
class IndexView(View):
    def get(self,request):
        ...
        categoryId = request.GET.get("category_url")#mention in index.html line no 10 to sort the items according to category
        if categoryId:
